 ...
 * Original file: D:\\workspace_eclipse\\DeveloperAndroid\\src\\com\\thinkandroid\\util\\download\\IDownloadService.aidl
 */
package com.thinkandroid.util.download;
public interface IDownloadService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.thinkandroid.util.download.IDownloadService
{
private static final java.lang.String DESCRIPTOR = "com.thinkandroid.util.download.IDownloadService";
...
/**
 * Cast an IBinder object into an com.thinkandroid.util.download.IDownloadService interface,
 * generating a proxy if needed.
 */
public static com.thinkandroid.util.download.IDownloadService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.thinkandroid.util.download.IDownloadService))) {
return ((com.thinkandroid.util.download.IDownloadService)iin);
}
return new com.thinkandroid.util.download.IDownloadService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.thinkandroid.util.download.IDownloadService
{
