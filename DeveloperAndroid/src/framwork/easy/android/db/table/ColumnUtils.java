...
import framwork.easy.android.db.annotation.Check;
import framwork.easy.android.db.annotation.Column;
import framwork.easy.android.db.annotation.Finder;
import framwork.easy.android.db.annotation.Foreign;
import framwork.easy.android.db.annotation.Id;
import framwork.easy.android.db.annotation.NotNull;
import framwork.easy.android.db.annotation.Transient;
import framwork.easy.android.db.annotation.Unique;
...
public class ColumnUtils {
    ...
    public static Method getColumnGetMethod(Class<?> entityType, Field field) {
        ...
        if (getMethod == null) {
            ...
            try {
                ...
                Log.d(Tags.TAG_EXCEPTION,methodName + " not exist");
            }
        }
    ...
    public static Class<?> getForeignEntityType(framwork.easy.android.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(framwork.easy.android.db.table.Finder finderColumn) {
