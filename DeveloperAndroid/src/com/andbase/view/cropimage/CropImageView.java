 ...
 */
package com.andbase.view.cropimage;
...
public class CropImageView extends CropViewBase {
     ...
     * @see com.andbase.view.cropimage.CropViewBase#onLayout(boolean, int, int, int, int)
     * @author: zhaoqp
     ...
     * @see com.andbase.view.cropimage.CropViewBase#zoomTo(float, float, float)
     * @author: zhaoqp
     * @date：2013-6-17 上午9:04:49
     * @version v1.0
     */
     ...
     * 描述：TODO.
     *
     * @see com.andbase.view.cropimage.CropViewBase#zoomIn()
     * @author: zhaoqp
     * @date：2013-6-17 上午9:04:49
     * @version v1.0
     */
     ...
     * 描述：TODO.
     *
     * @see com.andbase.view.cropimage.CropViewBase#zoomOut()
     * @author: zhaoqp
     * @date：2013-6-17 上午9:04:49
     * @version v1.0
     */
     ...
     * @see com.andbase.view.cropimage.CropViewBase#postTranslate(float, float)
     * @author: zhaoqp
     * @date：2013-6-17 上午9:04:49
     * @version v1.0
     */
