 ...
 */
package com.andbase.view.chart;
...
public class ScatterChart extends XYChart {
   ...
   * @see com.andbase.view.chart.XYChart#setDatasetRenderer(com.andbase.view.chart.XYMultipleSeriesDataset, com.andbase.view.chart.XYMultipleSeriesRenderer)
   * @author: zhaoqp
   ...
   * @see com.andbase.view.chart.XYChart#clickableAreasForPoints(float[], double[], float, int, int)
   * @author: zhaoqp
   * @date：2013-6-17 上午9:04:49
   * @version v1.0
   */
