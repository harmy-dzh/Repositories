...
import com.andbase.view.listener.AbOnListViewListener;
import com.andbase.view.pullview.AbMultiColumnBaseAbsListView.OnScrollListener;
...
public class AbMultiColumnListView extends AbMultiColumnBaseListView implements OnScrollListener {
	...
	/**
	 * 描述：TODO
	 * @see com.andbase.view.pullview.AbMultiColumnAbsListView#setAdapter(android.widget.ListAdapter)
	 * @author: zhaoqp
	...
	/**
	 * 描述：TODO
	 * @see com.andbase.view.pullview.AbMultiColumnBaseAbsListView.OnScrollListener#onScrollStateChanged(com.andbase.view.pullview.AbMultiColumnBaseAbsListView, int)
	 * @author: zhaoqp
	 * @date：2013-9-4 下午4:06:32
	 * @version v1.0
	 */
	...
	/**
	 * 描述：TODO
	 * @see com.andbase.view.pullview.AbMultiColumnBaseAbsListView.OnScrollListener#onScroll(com.andbase.view.pullview.AbMultiColumnBaseAbsListView, int, int, int)
	 * @author: zhaoqp
	 * @date：2013-9-4 下午4:06:32
	 * @version v1.0
	 */
